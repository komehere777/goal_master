...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: '목표 관리', href: '/goals', current: location.pathname === '/goals' },
    { name: '진도 추적', href: '/progress', current: location.pathname === '/progress' },
    { name: '커뮤니티', href: '/community', current: location.pathname === '/community' },
  ];
